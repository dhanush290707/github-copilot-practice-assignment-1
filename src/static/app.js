            ...
            <div class="participants-section">
              ...
              <div class="participants-list">
                ${details.participants
                  .map(
                    (email) =>
                      `<div class="participant-item"><span class="participant-email">${email}</span> <span class="delete-icon" title="Remove participant" data-activity="${name}" data-email="${email}">&#128465;</span></div>`
                  )
                  .join("")}
              </div>
            </div>
